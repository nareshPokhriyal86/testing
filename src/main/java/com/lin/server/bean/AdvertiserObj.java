 ...
 * This entity is used in campaign setup to create advertisers in datastore
 */

@SuppressWarnings("serial")
@Index
public class AdvertiserObj implements Serializable {
	@Id	private Long id;   
	...
	public AdvertiserObj(){
	}

	public AdvertiserObj(long advertiserId,String name,String dfpNetworkCode){		
		this.advertiserId=advertiserId;
		this.name=name;
		this.dfpNetworkCode=dfpNetworkCode;
	}
	
	public AdvertiserObj(Long id, long advertiserId,String name){
		this.id=id;
		this.advertiserId=advertiserId;
		this.name=name;
	}
	public AdvertiserObj(String name, String address, String state,
	...
	public String toString() {
		...
		builder.append("AdvertiserObj [id=");
		builder.append(id);
