...
public class AuthorisationText implements Serializable{

	@Id	private Long id;
	private String rolesAndAuthorisationColumnName;
	private String authorisationText;
	private String authorisationTextKeyword;
	private String authorisationForPage;
	private String authorisationTextStatus;
	private String permission;
	
	
	public AuthorisationText() {
	}
	
	public AuthorisationText(String RolesAndAuthorisationColumnName, String AuthorisationText, String AuthorisationTextKeyword, String AuthorisationForPage, String AuthorisationTextStatus) {
