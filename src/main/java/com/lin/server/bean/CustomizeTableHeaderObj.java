...
public class CustomizeTableHeaderObj implements Serializable {
	...
	public CustomizeTableHeaderObj(){};
	
	public CustomizeTableHeaderObj(String id, String name, String column1,
			...
			String column14, String column15, String column16, String column17,
			String column18, String column19, String column20, String column21,
			String column22, String column23, String column24, String column25) {
		super();
		this.id = id;
		this.name = name;
