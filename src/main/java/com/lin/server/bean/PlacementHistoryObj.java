...
/*
 * It is a PlacementHistoryObj entity bean 
 * referenced by ProposalObj
 *  
 * @author Youdhveer Panwar
 */
@Index
public class PlacementHistoryObj implements Serializable {
    ...
    private String updateDeleteByUserId;
	
	public PlacementHistoryObj(){
		
	}
	
	
	public PlacementHistoryObj(long proposalId, String placementId,
	...
	public void setUpdateDeleteByUserId(String updateDeleteByUserId) {
		this.updateDeleteByUserId = updateDeleteByUserId;
	}


	public String getUpdateDeleteByUserId() {
