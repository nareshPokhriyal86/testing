...
public class LinDigitalRichMediaDataAction implements ServletRequestAware,SessionAware{

	
	private static final Logger log = Logger.getLogger(LinDigitalRichMediaDataAction.class.getName());
	...
	public String dailyLinDigitalReport(){		
		log.info("customEventDailyLinDigitalReport action executes..");		
	...
	public String updateDailyLinDigitalNonFinaliseReport(){
		log.info("customEventNonFinaliseLinDigitalReport action starts...");
	...
	public String updateMonthwiseLinDigitalFinaliseReport(){		
		log.info("customEventFinaliseLinDigitalReport action executes..");
		       ...
		       /* List<String> accountIdList=new ArrayList<String>();
		    	...
		    	if(csvData !=null){
		    	    ...
		    	    String dirName=LinMobileConstants.REPORT_FOLDER+ "/"+
	    		                   ...
	    		                   "/Custom_Events/LinDigital/non_finalise/"+
		    	                   month;
		    		...
		    		response=service.generateRichMediaCustomEventReport(rawFileName,processFile,
		    				dirName,dataSource,networkCode,LinMobileConstants.LIN_DIGITAL_PUBLISHER_ID,
