...
public class LinMobileDFPTargetReportAction implements ServletRequestAware,SessionAware{

	
	private static final Logger log = Logger.getLogger(LinMobileDFPTargetReportAction.class.getName());
	...
	public String dailyLinMobileReport(){		
		log.info("targetDailyLinMobileReport action executes..");		
	...
	public String updateDailyLinMobileNonFinaliseReport(){
		log.info("targetNonFinaliseLinMobileReport action starts...");
	...
	public String updateMonthwiseLinMobileFinaliseReport(){		
		log.info("targetFinaliseLinMobileReport action executes..");
	...
	private String runNonFinaliseLinMobileReport(String startDate,String endDate,String accountId,String orderId){
	    	...
	    	try {	
		    	...
		    	if(csvData !=null){
		    		...
		    		response=service.generateDFPTargetReport(startDate, endDate,rawFileName,dirName,networkCode,
		    				LinMobileConstants.LIN_MOBILE_PUBLISHER_ID,LinMobileConstants.LIN_MOBILE_PUBLISHER_NAME,bucketName);
	...
	public String dailyLinMobileNewReport(){		
		log.info("targetDailyLinMobileNewReport action executes..");		
	    boolean dateCheck=true;
		String startDate=request.getParameter("start");		
		String endDate=request.getParameter("end");		
		String accountId=request.getParameter("accountId");
	...
	private String runNonFinaliseLinMobileNewReport(String startDate,String endDate,String accountId,String orderId){
	    	...
	    	try {	
		    	...
		    	if(csvData !=null){
		    	    ...
		    	    String dirName=LinMobileConstants.REPORT_FOLDER+ "/"+
		    		               LinMobileConstants.DFP_TARGET_REPORT_BUCKET+		    	                  
		    	                   "/LinMobile/non_finalise_"+networkCode+"/"+
		    	                   month;
