...
public class RichMediaAdvertiserViewAction implements
ModelDriven<UserDetailsDTO>, ServletRequestAware, SessionAware{
	
	private static final Logger log = Logger.getLogger(RichMediaAdvertiserViewAction.class.getName());
    ...
    private Map<String,List<AdvertiserPerformerDTO>> advertiserTotalDataListCurrentMap;
    private Map<String,List<AdvertiserPerformerDTO>> advertiserTotalDataListCompareMap;
    private Map<String,List<AdvertiserPerformerDTO>> advertiserTotalDataListMTDMap;
    ...
    private List<AdvertiserPerformerDTO> richMediaEventPopupList;
    private List<AdvertiserPerformerDTO> campaignTraffickingDataList;
    
    public String deploymentVersion = LinMobileConstants.DEPLOYMENT_VERSION;
    
 	public String execute(){
			log.info("RichMediaAdvertiserViewAction action executes..");
    ...
    public String loadAllLineItemName(){    
    	log.info("Inside loadAllLineItemName of RichMediaAdvertiserViewAction.");
    ...
    public String loadTrendAnalysisHeaderDataAdvertiserView() throws Exception{
		...
		IRichMediaAdvertiserService service = (IRichMediaAdvertiserService) BusinessServiceLocator.locate(IRichMediaAdvertiserService.class);
		...
		advertiserTrendAnalysisHeaderList = service.loadTrendAnalysisHeaderDataAdvertiserView(lowerDate, upperDate, canpainOrder, lineOrder, publisherName);	
    ...
    public String loadTrendAnalysisActualDataAdvertiserView(){
    	log.info("inside loadTrendAnalysisActualData in RichMediaAdvertiserViewAction ");
    	String lowerDate=request.getParameter("startDate");
		String upperDate=request.getParameter("endDate");	
		...
		advertiserTrendAnalysisActualDatarList = service.loadTrendAnalysisActualDataAdvertiserView(lowerDate, upperDate, order, lineItem, publisherName);
    ...
    public String loadTrendAnalysisForcastDataAdvertiserView(){
		...
		advertiserTrendAnalysisForcastlDatarList = service.loadTrendAnalysisForcastDataAdvertiserView(lowerDate, upperDate, order, lineItem, publisherName);
    ...
    public String loadAdvertiserBylocationGraphData(){ 
    	log.info("Inside loadAdvertiserBylocationGraphData in RichMediaAdvertiserViewAction");
    	try {
	    	String lowerDate=request.getParameter("startDate");
			String upperDate=request.getParameter("endDate");
    ...
    public String loadAdvertiserByMarketGraphData(){ 
    	log.info("Inside loadAdvertiserByMarketGraphData in RichMediaAdvertiserViewAction");
    	try {
	    	String lowerDate=request.getParameter("startDate");
			String upperDate=request.getParameter("endDate");
			String advertiser=request.getParameter("advertiser");
    ...
    public String loadLineItemForPopup(){
    	log.info("Inside loadLineItemForPopup in RichMediaAdvertiserViewAction");
    	try {
	    	String lowerDate=request.getParameter("startDate");
			String upperDate=request.getParameter("endDate");		
    ...
    public String actualLineGraphAdvertiser() { 
    	try {
			...
			advertiserTrendAnalysisActualDataGraphList = service.loadTrendAnalysisActualDataAdvertiserView(lowerDate, upperDate, orderArr, lineOrderArr, publisherName);
    ...
    public  Map<String,String> createActualLineGraph(List<AdvertiserTrendAnalysisActualDTO> advertiserTrendAnalysisActualDataList){
    	log.info("Inside createActualLineGraph in RichMediaAdvertiserViewAction");
		...
		if(lineOrderArr!=null && !lineOrderArr.equals("")){
			...
			Iterator<AdvertiserTrendAnalysisActualDTO> iterator = advertiserTrendAnalysisActualDataList.iterator();
			if(advertiserTrendAnalysisActualDataList!=null && advertiserTrendAnalysisActualDataList.size()>0){
				while(iterator.hasNext()){
					
					lineOrderList.add(iterator.next().getLineItem());
				}
				Collections.sort(lineOrderList);
			}
    ...
    public String forcastLineGraphAdvertiser() { 
    	...
    	try {
			...
			advertiserTrendAnalysisForcastlDatarList = service.loadTrendAnalysisForcastDataAdvertiserView(lowerDate, upperDate, orderArr, lineOrderArr, publisherName);
    ...
    {
    	log.info("Inside loadAgencyDropDownList in RichMediaAdvertiserViewAction");
    	try {
    		String selectedPublisherId = request.getParameter("selectedPublisherId");
    		String term = request.getParameter("term");
    		IRichMediaAdvertiserService service = (IRichMediaAdvertiserService) BusinessServiceLocator.locate(IRichMediaAdvertiserService.class);
    		sessionDTO = (SessionObjectDTO) session.get("sessionDTO");
			agencies = service.getAgencyDropDownList(selectedPublisherId,term, sessionDTO.getUserId());
	    }
		catch (Exception e) {
    ...
    public String loadAdvertiserDropDownList()
    {
    	...
    	log.info("Inside loadAdvertiserDropDownList in RichMediaAdvertiserViewAction");
    	try {
    		String selectedPublisherId = request.getParameter("selectedPublisherId");
    		String agencyId = request.getParameter("agencyId");
    		String term = request.getParameter("term");
    		log.info("INSIDE GET ADVERTISER DROP DOWN LIST() "+selectedPublisherId+" "+agencyId+" "+term);
    		
    		sessionDTO = (SessionObjectDTO) session.get("sessionDTO");
    		IRichMediaAdvertiserService service = (IRichMediaAdvertiserService) BusinessServiceLocator.locate(IRichMediaAdvertiserService.class);
			advertisers = service.getAdvertiserDropDownList(selectedPublisherId,agencyId,term, sessionDTO.getUserId());
	    }
		catch (Exception e) {
    ...
    public String loadOrderDropDownList()
    {
    	...
    	log.info("Inside loadOrderDropDownList in RichMediaAdvertiserViewAction");
    	try {
    ...
    public String loadLineItemDropDownList()
    {
    	...
    	log.info("Inside loadLineItemDropDownList in RichMediaAdvertiserViewAction");
    	try {
    		String publisherName = request.getParameter("publisherName");
    		String agencyId = request.getParameter("agencyId");
    		String advertiserId = request.getParameter("advertiserId");
	  ...
	  public String loadAdvertiserPropertyDropDownList()
	    {
	    	...
	    	try {
	    		sessionDTO = (SessionObjectDTO) session.get("sessionDTO");
	    		String publisherId = request.getParameter("selectedPublisherId");
	    		long userId = sessionDTO.getUserId();
	    		String term = request.getParameter("term");
	    		IRichMediaAdvertiserService service = (IRichMediaAdvertiserService) BusinessServiceLocator.locate(IRichMediaAdvertiserService.class);
	    		siteDropDownList = service.loadAdvertiserPropertyDropDownList(publisherId,userId,term);
	    ...
	    public String loadAdvertiserTotalDataListCurrent(){
	    	log.info("inside loadAdvertiserTotalDataListCurrent in RichMediaAdvertiserViewAction class");
	    	try{
	    	//String lowerDate=request.getParameter("startDate");
			//String upperDate=request.getParameter("endDate");
	    ...
	    public String loadLineItemForcast(String lineItemId){
	    	try{
	    		sessionDTO = (SessionObjectDTO) session.get("sessionDTO");
	    		clientLoginToken = regenerateAuthToken();
			      log.info(" clientLoginToken : "+clientLoginToken);
	    ...
	    public String loadRichMediaEventPopup(){
	    	log.info("Inside loadRichMediaEventPopup in RichMediaAdvertiserViewAction");
	    	try {
				String lowerDate=request.getParameter("startDate");
				String upperDate=request.getParameter("endDate");
				String lineItemName = request.getParameter("lineItem");
				IRichMediaAdvertiserService service = (IRichMediaAdvertiserService) BusinessServiceLocator.locate(IRichMediaAdvertiserService.class);
				
				lowerDate = lowerDate+" 00:00:00";
				upperDate = upperDate+" 00:00:00";
				/*lowerDate = "2013-01-05 00:00:00";
				upperDate = "2013-09-05 00:00:00";
				lineItemName = "GolfsmithUSA-Mobile_13-0626_SF_ANDROID_CF";*/
				
				log.info("lowerDate : "+lowerDate+", upperDate : "+upperDate+" and lineItemName : "+lineItemName);
				richMediaEventPopupList = service.loadRichMediaEventPopup(lowerDate, upperDate, lineItemName);
				/*AdvertiserPerformerDTO dto = new AdvertiserPerformerDTO();
				dto.setCustomEvent("Custom Event Value,,v    f,kfklflfl");
				dto.setCustomizedCustomEvent("Custom Event Value");
				dto.setValue("457");
				richMediaEventPopupList.add(0,dto);*/
	    ...
	    public String loadRichMediaEventGraph(){
	    	log.info("Inside loadRichMediaEventGraph in RichMediaAdvertiserViewAction");
	    	try{
	    		String lowerDate=request.getParameter("startDate");
				String upperDate=request.getParameter("endDate");
				String advertiser=request.getParameter("advertiser");
	...
	public void setRichMediaEventPopupList(List<AdvertiserPerformerDTO> richMediaEventPopupList) {
		this.richMediaEventPopupList = richMediaEventPopupList;
	}



	public List<AdvertiserPerformerDTO> getRichMediaEventPopupList() {
	...
	public List<AdvertiserPerformerDTO> getCampaignTraffickingDataList() {
	...
	public void setCampaignTraffickingDataList(
			List<AdvertiserPerformerDTO> campaignTraffickingDataList) {
	...
	public void setAdvertiserTotalDataListCurrentMap(
			Map<String,List<AdvertiserPerformerDTO>> advertiserTotalDataListCurrentMap) {
		this.advertiserTotalDataListCurrentMap = advertiserTotalDataListCurrentMap;
	}



	public Map<String,List<AdvertiserPerformerDTO>> getAdvertiserTotalDataListCurrentMap() {
		return advertiserTotalDataListCurrentMap;
	}



	public void setAdvertiserTotalDataListCompareMap(
			Map<String,List<AdvertiserPerformerDTO>> advertiserTotalDataListCompareMap) {
		this.advertiserTotalDataListCompareMap = advertiserTotalDataListCompareMap;
	}



	public Map<String,List<AdvertiserPerformerDTO>> getAdvertiserTotalDataListCompareMap() {
		return advertiserTotalDataListCompareMap;
	}



	public void setAdvertiserTotalDataListMTDMap(
			Map<String,List<AdvertiserPerformerDTO>> advertiserTotalDataListMTDMap) {
		this.advertiserTotalDataListMTDMap = advertiserTotalDataListMTDMap;
	}



	public Map<String,List<AdvertiserPerformerDTO>> getAdvertiserTotalDataListMTDMap() {
		return advertiserTotalDataListMTDMap;
	}
