...
public class RichMediaDataAction implements ServletRequestAware,SessionAware{

	
	private static final Logger log = Logger.getLogger(RichMediaDataAction.class.getName());
	...
	public String dailyLinMediaReport(){		
		log.info("customEventDailyLinMediaReport action executes..");		
	...
	public String updateDailyLinMediaNonFinaliseReport(){
		log.info("customEventNonFinaliseLinMediaReport action starts...");
	...
	public String updateMonthwiseLinMediaFinaliseReport(){		
		log.info("customEventFinaliseLinMediaReport action executes..");
	    	...
	    	try {	
		    	...
		    	if(csvData !=null){
		    	    ...
		    	    String dirName=LinMobileConstants.REPORT_FOLDER+ "/"+
	    		                   ...
	    		                   "/Custom_Events/LinMedia/non_finalise/"+
		    	                   month;
		    		...
		    		response=service.generateRichMediaCustomEventReport(rawFileName,processFile,
		    				dirName,dataSource,networkCode,null,null,bucketName);
