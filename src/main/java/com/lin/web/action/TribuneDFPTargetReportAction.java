...
public class TribuneDFPTargetReportAction implements ServletRequestAware,SessionAware{

	
	private static final Logger log = Logger.getLogger(TribuneDFPTargetReportAction.class.getName());
	...
	public String dailyReport(){		
		log.info("targetDailyTribuneReport action executes..");		
	...
	public String updateDailyNonFinaliseReport(){
		log.info("targetNonFinaliseTribuneReport action starts...");
	...
	public String updateMonthwiseFinaliseReport(){		
		log.info("targetFinaliseTribuneReport action executes..");
	 ...
	 private String runNonFinaliseReport(String startDate,String endDate,String accountId){
	    	...
	    	try {	
		        ...
		        String downloadUrl = dfpReportService.getDFPTargetReportByAccountIds(dfpServices, dfpSession,
		    	...
		    	if(csvData !=null){
		    		...
		    		response=service.generateDFPTargetReport(startDate, endDate,rawFileName,dirName,networkCode,
		    				LinMobileConstants.TRIBUNE_DFP_PUBLISHER_ID,LinMobileConstants.TRIBUNE_DFP_PUBLISHER_NAME,bucketName);
