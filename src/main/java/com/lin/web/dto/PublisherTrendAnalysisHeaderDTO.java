...
public class PublisherTrendAnalysisHeaderDTO {
	...
	public PublisherTrendAnalysisHeaderDTO() {
		
	}
	
	
	public PublisherTrendAnalysisHeaderDTO(String requests, String delivered,
