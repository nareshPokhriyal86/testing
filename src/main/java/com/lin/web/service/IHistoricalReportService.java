...
public interface IHistoricalReportService extends IBusinessService{
	...
	DFPTaskEntity getTaskEntryByName(String taskName);
	void saveOrUpdateTask(DFPTaskEntity entity);
	DFPTaskEntity getDFPTaskEntity(String entityId);
	DFPTaskEntity saveInProgressTask(String taskName, String networkCode,
