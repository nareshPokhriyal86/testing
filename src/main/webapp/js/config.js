	...
	**/
	...
	function setup_calendar(jsonarray) {
	...
	function setup_sparklines(){
		...
		if ($('.mystats').length){
			...
			$('#reall_ecpm').sparkline([18,17,22,19,23,18,22,24,17,20,16,17], {
				type : 'bar',
				barColor : $chrt_fourth,
				height : '21px',
				barWidth : "2px",
			...
			$('#reall_rpm').sparkline([18,17,22,19,23,18,22,24,17,20,16,17], {
				type : 'bar',
				barColor : $chrt_second,
				height : '21px',
				barWidth : "2px",
	...
	function setup_easypie(){
       ...
       /* lighter version */
		...
		if ($('.percentage1').length) { 
			$.percentage_easy_pie = $('.percentage1');	
			$.percentage_easy_pie.easyPieChart({
				animate: 2000,
				trackColor:	"#515151",
				scaleColor:	"#515151",
		...
		if ($('.percentage2').length) { 
			$.percentage_easy_pie = $('.percentage2');	
			$.percentage_easy_pie.easyPieChart({
				animate: 2000,
				trackColor:	"#515151",
				scaleColor:	"#515151",
		...
		if ($('.percentage3').length) { 
			$.percentage_easy_pie = $('.percentage3');	
			$.percentage_easy_pie.easyPieChart({
				animate: 2000,
				trackColor:	"#515151",
				scaleColor:	"#515151",
		...
		if ($('.percentage4').length) { 
			$.percentage_easy_pie = $('.percentage4');	
			$.percentage_easy_pie.easyPieChart({
				animate: 2000,
				trackColor:	"#515151",
				scaleColor:	"#515151",
	...
	function setup_uislider() {
		if ($('#uislider-demo').length) {	
		    ...
		    $( "#slider-range-min-ctr" ).slider({
	            ...
	            max: 1,
	            slide: function( event, ui ) {
	                $( "#amount2" ).val(  ui.value.toFixed(2) + "%" );
	               // $('#slider-range-min-ctr .ui-slider-handle:first').html('<div class="tooltip top slider-tip"><div class="tooltip-arrow"></div><div class="tooltip-inner">' + ui.value.toFixed(2) + '</div></div>');
	            }
	        });
		    $("#amount2").val( $("#slider-range-min-ctr" ).slider("value").toFixed(2) + "%");
