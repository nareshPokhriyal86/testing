...
!function ($) {
    ...
    var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
            '<div class="calendar left" style="display:block!important;"></div>' +
            '<div class="calendar right" style="display:block!important;"></div>' +
            '<div class="ranges">' +
              
                '<button  id= "submit_calender" onclick="hideDatePicker();" class=" ' + this.applyClass + ' applyBtn" disabled="disabled">' + this.locale.applyLabel + '</button>&nbsp;' +
                '<button class="' + this.clearClass + ' btn-danger clearBtn">' + this.locale.clearLabel + '</button>' +
              '</div>' +
              '<div class="range_inputs">' +
				
              '<div class="daterangepicker_start_input" style="float: left;margin-top:-160px;margin-left: 7px;">' +
                '<label for="daterangepicker_start" style="float:left;margin-right:5px;margin-top: 10px;">' + this.locale.fromLabel + '</label>' +
                '<input style="float:left;margin-top:5px;" class="input-mini" type="text" name="daterangepicker_start" value="" disabled="disabled" />' +
              '</div>' +
              '<div class="daterangepicker_end_input" style="float: left; padding-left: 253px;margin-top:-160px;">' +
                '<label for="daterangepicker_end" style="float:left;margin-right:5px;margin-top: 10px;">' + this.locale.toLabel + '</label>' +
                '<input style="float:left;margin-top:5px;" class="input-mini" type="text" name="daterangepicker_end" value="" disabled="disabled" />' +
              '</div>' +
              '<div class="custom_compare" style="float: left;margin-top:-37px;height:36px;margin-left:7px;">'+
				'<input type="checkbox" id="compare_checbox" style="margin-right:5px;float:left;" checked="checked"/>'+
				'<label for="daterangepicker_start" style="float:left;margin-top:3px;">' + this.locale.compareperiod + '</label>' +
				'<div class="customcompare_period" style="float: left;margin-bottom:5px;margin-left:5px;">'+
				'<select style="width:140px;float:left;" disabled>'+
							 ' <option value="volvo">Previous period</option>'+
						'</select>'+
				'</div>'+
				'</div>'+
    ...
    var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
     ...
     '<div class="ranges">' +
       ...
       '</div>' +
         ...
         '<div id="dateRangeStartDateText" class="daterangepicker_start_input" style="float: left;margin-top:-9%;margin-left: 7px;">' +
           '<label for="daterangepicker_start" style="float:left;margin-right:5px;margin-top: 10px;">' + this.locale.fromLabel + '</label>' +
           '<input style="float:left;margin-top:5px;" class="input-mini" type="text" name="daterangepicker_start" value="" disabled="disabled" />' +
         '</div>' +
         '<div id="dateRangeEndDateText" class="daterangepicker_end_input" style="float: left; padding-left: 253px;margin-top:-9%;">' +
           '<label for="daterangepicker_end" style="float:left;margin-right:5px;margin-top: 10px;">' + this.locale.toLabel + '</label>' +
           '<input style="float:left;margin-top:5px;" class="input-mini" type="text" name="daterangepicker_end" value="" disabled="disabled" />' +
         '</div>' +
         '<div id="custom_compare_div" class="custom_compare" style="float: left;margin-top:-37px;height:36px;margin-left:7px;">'+
			'<input type="checkbox" id="compare_checbox" style="margin-right:5px;float:left;" checked="checked"/>'+
			'<label for="daterangepicker_start" style="float:left;margin-top:3px;">' + this.locale.compareperiod + '</label>' +
			'<div class="customcompare_period" style="float: left;margin-bottom:5px;margin-left:5px;">'+
			'<select style="width:140px;float:left;" disabled>'+
