			...
			(function(i) {
				var l = function(h) {
					function n(a, b) {
						...
						a.aoColumns.push(b);
						if (a.aoPreSearchCols[d] === p
								|| a.aoPreSearchCols[d] === null)
							a.aoPreSearchCols[d] = i.extend({},
									l.models.oSearch);
						else {
					...
					function q(a, b, c) {
						...
						var e = d.mRender ? ca(d.mRender) : null, f = ca(d.mData);
						...
						if (!a.oFeatures.bSort)
							d.bSortable = false;
						if (!d.bSortable || i.inArray("asc", d.asSorting) == -1
								&& i.inArray("desc", d.asSorting) == -1) {
							d.sSortingClass = a.oClasses.sSortableNone;
							d.sSortingClassJUI = ""
						} else if (i.inArray("asc", d.asSorting) == -1
								&& i.inArray("desc", d.asSorting) == -1) {
								...
								for (g = m.length; f < g; f++)
									if (typeof m[f] === "number" && m[f] >= 0) {
										for (; a.aoColumns.length <= m[f];)
											n(a);
										d(m[f], b[e])
									} else if (typeof m[f] === "number"
											&& m[f] < 0)
										d(a.aoColumns.length + m[f], b[e]);
									else if (typeof m[f] === "string") {
										j = 0;
					...
					function R(a, b) {
						...
						for ( var f = a.aoColumns.length; d < f; d++) {
							c = a.aoColumns[d];
							typeof c.fnRender === "function" && c.bUseRendered
									&& c.mData !== null ? S(a, b, d,
									da(a, b, d)) : S(a, b, d, F(a, b, d));
					...
					function ea(a) {
						...
						for (e = a.aoColumns.length; c < e; c++) {
							...
							if (k || m || u || !x) {
								...
								for (b = a.aoData.length; g < b; g++) {
									...
									j.fnCreatedCell
											&& j.fnCreatedCell.call(
													a.oInstance, y, F(a, g, c,
															"display"),
													f._aData, g, c)
								}
							}
						...
						if (a.aoRowCreatedCallback.length !== 0) {
							...
							for (c = a.aoData.length; b < c; b++) {
								f = a.aoData[b];
								K(a, "aoRowCreatedCallback", null, [ f.nTr,
										f._aData, b ])
							}
						}
					}
					...
					function F(a, b, c, d) {
						...
						if ((c = e.fnGetData(a.aoData[b]._aData, d)) === p) {
							if (a.iDrawError != a.iDraw
									&& e.sDefaultContent === null) {
								O(
										a,
										0,
										"Requested unknown parameter "
												+ (typeof e.mData == "function" ? "{mData function}"
														: "'" + e.mData + "'")
					...
					function ua(a, b) {
						...
						if (c.nTr === null) {
							...
							for ( var e = 0, f = a.aoColumns.length; e < f; e++) {
								...
								d.innerHTML = typeof g.fnRender === "function"
										&& (!g.bUseRendered || g.mData === null) ? da(
										a, b, e)
										: F(a, b, e, "display");
								if (g.sClass !== null)
									d.className = g.sClass;
								if (g.bVisible) {
									c.nTr.appendChild(d);
									c._anHidden[e] = null
								} else
									c._anHidden[e] = d;
								g.fnCreatedCell
										&& g.fnCreatedCell.call(a.oInstance, d,
												F(a, b, e, "display"),
												c._aData, b, e)
							}
							K(a, "aoRowCreatedCallback", null, [ c.nTr,
									c._aData, b ])
						}
					}
					function Ka(a) {
						...
						if (i("th, td", a.nTHead).length !== 0) {
							...
							for (d = a.aoColumns.length; b < d; b++) {
								...
								a.aoColumns[b].sClass !== null
										&& i(c).addClass(a.aoColumns[b].sClass);
						...
						if (a.oFeatures.bSort)
							for (b = 0; b < a.aoColumns.length; b++)
								a.aoColumns[b].bSortable !== false ? ya(a,
										a.aoColumns[b].nTh, b) : i(
										a.aoColumns[b].nTh).addClass(
										a.oClasses.sSortableNone);
						a.oClasses.sFooterTH !== ""
								&& i(a.nTFoot).children("tr").children("th")
					...
					function H(a) {
						...
						if (i.inArray(false, b) !== -1)
							...
							a.bDrawing = true;
							if (a.iInitDisplayStart !== p
									&& a.iInitDisplayStart != -1) {
								a._iDisplayStart = a.oFeatures.bServerSide ? a.iInitDisplayStart
										: a.iInitDisplayStart >= a
												.fnRecordsDisplay() ? 0
												: a.iInitDisplayStart;
								a.iInitDisplayStart = -1;
								I(a)
							...
							if (a.aiDisplay.length !== 0) {
								...
								for (g = g; g < d; g++) {
									...
									var k = j.nTr;
									if (f !== 0) {
										var m = a.asStripeClasses[e % f];
										if (j._sRowStripe != m) {
											i(k).removeClass(j._sRowStripe)
													.addClass(m);
											j._sRowStripe = m
										}
									}
									K(a, "aoRowCallback", null, [ k,
											a.aoData[a.aiDisplay[g]]._aData, e,
											g ]);
									b.push(k);
									e++;
									if (c !== 0)
								...
								c = a.oLanguage;
								f = c.sZeroRecords;
								if (a.iDraw == 1 && a.sAjaxSource !== null
										&& !a.oFeatures.bServerSide)
									f = c.sLoadingRecords;
								else if (c.sEmptyTable
										&& a.fnRecordsTotal() === 0)
									f = c.sEmptyTable;
							...
							K(a, "aoHeaderCallback", "header", [
									i(a.nTHead).children("tr")[0], oa(a),
									a._iDisplayStart, a.fnDisplayEnd(),
									a.aiDisplay ]);
							K(a, "aoFooterCallback", "footer", [
									i(a.nTFoot).children("tr")[0], oa(a),
									a._iDisplayStart, a.fnDisplayEnd(),
									a.aiDisplay ]);
							...
							if (a.nTBody) {
								...
								if (!a.oScroll.bInfinite || !a._bInitComplete
										|| a.bSorted || a.bFiltered)
					...
					function Ma(a) {
						...
						a.nTableWrapper = i('<div id="' + a.sTableId
								+ '_wrapper" class="' + a.oClasses.sWrapper
								+ '" role="grid"></div>')[0];
						...
						for ( var c = a.nTableWrapper, d = a.sDom.split(""), e, f, g, j, k, m, u, x = 0; x < d.length; x++) {
							...
							if (g == "<") {
								...
								c = c.parentNode;
							else if (g == "l" && a.oFeatures.bPaginate
								...
								e = Sa(a);
								f = 1
							} else if (l.ext.aoFeatures.length !== 0) {
								j = l.ext.aoFeatures;
								u = 0;
					...
					function Ta(a) {
						...
						for (f = 0; f < b; f++) {
							...
							c.push({
								name : "mDataProp_" + f,
								value : typeof d === "function" ? "function"
										: d
							})
						}
						...
						if (a.oFeatures.bSort !== false) {
							var j = 0;
							d = a.aaSortingFixed !== null ? a.aaSortingFixed
					...
					function Ua(a, b) {
						if (b.sEcho !== p)
							if (b.sEcho * 1 < a.iDraw)
								...
								a.iDraw = b.sEcho * 1;
						if (!a.oScroll.bInfinite || a.oScroll.bInfinite
								&& (a.bSorted || a.bFiltered))
							wa(a);
						a._iRecordsTotal = parseInt(b.iTotalRecords, 10);
						a._iRecordsDisplay = parseInt(b.iTotalDisplayRecords,
								10);
						var c = Y(a);
					...
					function Oa(a) {
						...
						c = c.indexOf("_INPUT_") !== -1 ? c.replace("_INPUT_",
								'<input type="text" />')
								: c === "" ? '<input type="text" />' : c
										+ ' <input type="text" />';
						...
						c
								.bind(
										"keyup.DT",
										function() {
											for ( var e = a.aanFeatures.f, f = this.value === "" ? ""
													: this.value, g = 0, j = e.length; g < j; g++)
												e[g] != i(this)
														.parents(
					...
					function X(a, b, c) {
						var d = a.oPreviousSearch, e = a.aoPreSearchCols, f = function(
								g) {
							d.sSearch = g.sSearch;
							d.bRegex = g.bRegex;
							d.bSmart = g.bSmart;
						...
						if (a.oFeatures.bServerSide)
							...
							Va(a, b.sSearch, c, b.bRegex, b.bSmart,
									b.bCaseInsensitive);
							f(b);
							for (b = 0; b < a.aoPreSearchCols.length; b++)
								Wa(a, e[b].sSearch, b, e[b].bRegex,
					...
					function Xa(a) {
						for ( var b = l.ext.afnFiltering, c = A(a,
								"bSearchable"), d = 0, e = b.length; d < e; d++)
					...
					function Wa(a, b, c, d, e, f) {
						if (b !== "") {
							...
							for (d = a.aiDisplay.length - 1; d >= 0; d--) {
								e = Ya(F(a, a.aiDisplay[d], c, "filter"),
										a.aoColumns[c].sType);
								if (!b.test(e)) {
					...
					function Va(a, b, c, d, e, f) {
						...
						if (b.length <= 0) {
							...
							a.aiDisplay = a.aiDisplayMaster.slice()
								...
								|| e.sSearch.length > b.length
								|| c == 1
								|| b.indexOf(e.sSearch) !== 0) {
							a.aiDisplay.splice(0, a.aiDisplay.length);
							Ba(a, 1);
							for (b = 0; b < a.aiDisplayMaster.length; b++)
								d.test(a.asDataSearch[b])
										&& a.aiDisplay
												.push(a.aiDisplayMaster[b])
						} else
					...
					function Ba(a, b) {
						if (!a.oFeatures.bServerSide) {
							...
							for ( var d = 0, e = b.length; d < e; d++)
								a.asDataSearch[d] = Da(a, na(a, b[d], "filter",
										c))
						}
					}
					function Da(a, b) {
					...
					function Ra(a) {
						...
						a.nTable.setAttribute("aria-describedby", a.sTableId
								+ "_info");
						return b
					}
					function Za(a) {
						if (!(!a.oFeatures.bInfo || a.aanFeatures.i.length === 0)) {
							var b = a.oLanguage, c = a._iDisplayStart + 1, d = a
									.fnDisplayEnd(), e = a.fnRecordsTotal(), f = a
									.fnRecordsDisplay(), g;
							...
							if (b.fnInfoCallback !== null)
								g = b.fnInfoCallback.call(a.oInstance, a, c, d,
										e, f, g);
							a = a.aanFeatures.i;
							b = 0;
					...
					function za(a, b) {
						var c = a.fnFormatNumber(a._iDisplayStart + 1), d = a
								.fnDisplayEnd();
						...
						return b.replace(/_START_/g, c).replace(/_END_/g, d)
								.replace(/_TOTAL_/g, e).replace(/_MAX_/g, f)
					}
					function ra(a) {
					...
					function Fa(a) {
						...
						!a.sEmptyTable
								&& a.sZeroRecords
								&& b.sEmptyTable === "No data available in table"
								&& r(a, a, "sZeroRecords", "sEmptyTable");
						!a.sLoadingRecords && a.sZeroRecords
								&& b.sLoadingRecords === "Loading..."
								&& r(a, a, "sZeroRecords", "sLoadingRecords")
					}
					function Na(a) {
						if (a.oScroll.bInfinite)
							return null;
						var b = '<select size="1" '
								+ ('name="' + a.sTableId + '_length"') + ">", c, d, e = a.aLengthMenu;
						if (e.length == 2 && typeof e[0] === "object"
								&& typeof e[1] === "object") {
							c = 0;
							for (d = e[0].length; c < d; c++)
								b += '<option value="' + e[0][c] + '">'
										+ e[1][c] + "</option>"
						} else {
							c = 0;
							for (d = e.length; c < d; c++)
								b += '<option value="' + e[c] + '">' + e[c]
										+ "</option>"
						}
						b += "</select>";
						e = s.createElement("div");
						...
						e.innerHTML = "<label>"
								+ a.oLanguage.sLengthMenu.replace("_MENU_", b)
								+ "</label>";
						i('select option[value="' + a._iDisplayLength + '"]', e)
								.attr("selected", true);
						i("select", e).bind(
								"change.DT",
								function() {
					...
					function I(a) {
						a._iDisplayEnd = a.oFeatures.bPaginate === false ? a.aiDisplay.length
								: a._iDisplayStart + a._iDisplayLength > a.aiDisplay.length
										|| a._iDisplayLength == -1 ? a.aiDisplay.length
					...
					function Sa(a) {
						...
						l.ext.oPagination[a.sPaginationType].fnInit(a, b,
								function(c) {
									I(c);
									H(c)
								});
						a.aanFeatures.p
								|| a.aoDrawCallback.push({
									fn : function(c) {
										l.ext.oPagination[c.sPaginationType]
												.fnUpdate(c, function(d) {
													I(d);
													H(d)
												})
									},
					...
					function Ga(a, b) {
						...
						if (typeof b === "number") {
							...
							a._iDisplayStart = a._iDisplayLength >= 0 ? a._iDisplayStart
									- a._iDisplayLength
									: 0;
							if (a._iDisplayStart < 0)
								a._iDisplayStart = 0
							...
							if (a._iDisplayLength >= 0) {
								if (a._iDisplayStart + a._iDisplayLength < a
										.fnRecordsDisplay())
									a._iDisplayStart += a._iDisplayLength
							} else
								a._iDisplayStart = 0;
							...
							if (a._iDisplayLength >= 0) {
								b = parseInt((a.fnRecordsDisplay() - 1)
										/ a._iDisplayLength, 10) + 1;
					...
					function P(a, b) {
						if (a.oFeatures.bProcessing)
							for ( var c = a.aanFeatures.r, d = 0, e = c.length; d < e; d++)
								c[d].style.visibility = b ? "visible"
										: "hidden";
					...
					function Qa(a) {
						if (a.oScroll.sX === "" && a.oScroll.sY === "")
							return a.nTable;
						var b = s.createElement("div"), c = s
								.createElement("div"), d = s
								.createElement("div"), e = s
								.createElement("div"), f = s
								.createElement("div"), g = s
								.createElement("div"), j = a.nTable
								.cloneNode(false), k = a.nTable
								.cloneNode(false), m = a.nTable
								.getElementsByTagName("thead")[0], u = a.nTable
								.getElementsByTagName("tfoot").length === 0 ? null
								: a.nTable.getElementsByTagName("tfoot")[0], x = a.oClasses;
						c.appendChild(d);
						f.appendChild(g);
						...
						c.style.width = "100%";
						f.style.border = "0";
						d.style.width = a.oScroll.sXInner !== "" ? a.oScroll.sXInner
								: "100%";
					...
					function $a(a) {
						var b = a.nScrollHead.getElementsByTagName("div")[0], c = b
								.getElementsByTagName("table")[0], d = a.nTable.parentNode, e, f, g, j, k, m, u, x, y = [], B = [], T = a.nTFoot !== null ? a.nScrollFoot
								.getElementsByTagName("div")[0]
								: null, M = a.nTFoot !== null ? T
								.getElementsByTagName("table")[0] : null, L = a.oBrowser.bScrollOversize, ja = function(
								z) {
							u = z.style;
							u.paddingTop = "0";
							u.paddingBottom = "0";
						...
						if (a.oScroll.sX === "") {
							...
							if (L
									&& (i("tbody", d).height() > d.offsetHeight || i(
											d).css("overflow-y") == "scroll"))
								a.nTable.style.width = t(i(a.nTable)
										.outerWidth()
										- a.oScroll.iBarWidth)
						} else if (a.oScroll.sXInner !== "")
							a.nTable.style.width = t(a.oScroll.sXInner);
						else if (e == i(d).width()
								&& i(d).height() < i(a.nTable).height()) {
						...
						if (i(a.nTable).outerWidth() < e) {
							g = d.scrollHeight > d.offsetHeight
									|| i(d).css("overflow-y") == "scroll" ? e
									+ a.oScroll.iBarWidth : e;
							if (L
									&& (d.scrollHeight > d.offsetHeight || i(d)
						...
						if (a.oScroll.sY === "")
							if (L)
								d.style.height = t(a.nTable.offsetHeight
										+ a.oScroll.iBarWidth);
						if (a.oScroll.sY !== "" && a.oScroll.bCollapse) {
							d.style.height = t(a.oScroll.sY);
							L = a.oScroll.sX !== ""
									&& a.nTable.offsetWidth > d.offsetWidth ? a.oScroll.iBarWidth
									: 0;
						...
						c.style.width = t(L);
						b.style.width = t(L);
						c = i(a.nTable).height() > d.clientHeight
								|| i(d).css("overflow-y") == "scroll";
						b.style.paddingRight = c ? a.oScroll.iBarWidth + "px"
								: "0px";
						if (a.nTFoot !== null) {
							M.style.width = t(L);
							T.style.width = t(L);
							T.style.paddingRight = c ? a.oScroll.iBarWidth
									+ "px" : "0px"
						}
						i(d).scroll();
					...
					function ta(a) {
						var b = 0, c, d = 0, e = a.aoColumns.length, f, g, j = i(
								"th", a.nTHead), k = a.nTable
								.getAttribute("width");
						...
						if (e == j.length && b === 0 && d == e
							...
							for (f = d = 0; f < e; f++) {
								var m = a.aoColumns[f];
								if (m.bVisible && m.sWidthOrig !== null
										&& m.sWidthOrig !== "")
							...
							if (a.oScroll.sX !== "") {
								for (f = d = g = 0; f < a.aoColumns.length; f++)
									if (a.aoColumns[f].bVisible) {
										g += a.aoColumns[f].sWidthOrig === null ? i(
												e[d]).outerWidth()
												: parseInt(
														a.aoColumns[f].sWidth
																.replace("px",
																		""), 10)
														+ (i(e[d]).outerWidth() - i(
																e[d]).width());
							...
							e = i(b).css("width");
							a.nTable.style.width = e.indexOf("%") !== -1 ? e
									: t(i(b).outerWidth());
					...
					function $(a, b) {
						...
						if (!a.oFeatures.bServerSide
							...
							k = a.aaSortingFixed !== null ? a.aaSortingFixed
									.concat(a.aaSorting) : a.aaSorting.slice();
							for (c = 0; c < k.length; c++) {
								...
								if (l.ext.afnSortData[f]) {
									g = l.ext.afnSortData[f].call(a.oInstance,
											a, d, e);
								...
								if (k.length > 0 && k[0][0] == c) {
									...
									b
											.setAttribute(
													"aria-label",
													e
															+ ((y[c].asSorting[k[0][2] + 1] ? y[c].asSorting[k[0][2] + 1]
																	: y[c].asSorting[0]) == "asc" ? B.sSortAscending
																	: B.sSortDescending))
								} else
									b
											.setAttribute(
											...
											if (e.shiftKey) {
												...
												k === false
														&& a.aaSorting
																.push([
																		c,
																		a.aoColumns[c].asSorting[0],
																		0 ])
											} else if (a.aaSorting.length == 1
													&& a.aaSorting[0][0] == c) {
												g = a.aaSorting[0][0];
												j = a.aaSorting[0][2] + 1;
												a.aoColumns[g].asSorting[j]
														|| (j = 0);
												a.aaSorting[0][1] = a.aoColumns[g].asSorting[j];
												a.aaSorting[0][2] = j
											} else {
												a.aaSorting.splice(0,
														a.aaSorting.length);
												a.aaSorting
														.push([
																c,
					...
					function ba(a) {
						...
						c = a.aaSortingFixed !== null ? a.aaSortingFixed
								.concat(a.aaSorting) : a.aaSorting.slice();
						for (b = 0; b < a.aoColumns.length; b++)
							if (a.aoColumns[b].bSortable) {
								...
								if (a.bJUI) {
									f = i("span." + j.sSortIcon,
											a.aoColumns[b].nTh);
									f.removeClass(j.sSortJUIAsc + " "
											+ j.sSortJUIDesc + " " + j.sSortJUI
											+ " " + j.sSortJUIAscAllowed + " "
											+ j.sSortJUIDescAllowed);
									f
											.addClass(e == -1 ? a.aoColumns[b].sSortingClassJUI
													: c[e][1] == "asc" ? j.sSortJUIAsc
															: j.sSortJUIDesc)
								}
							} else
								i(a.aoColumns[b].nTh).addClass(
										a.aoColumns[b].sSortingClass);
						f = j.sSortColumn;
					...
					function Ha(a) {
						if (!(!a.oFeatures.bStateSave || a.bDestroying)) {
							...
							K(a, "aoStateSaveParams", "stateSaveParams",
									[ a, d ]);
						...
						if (a.oFeatures.bStateSave) {
							...
							if (c) {
								...
								if (i.inArray(false, d) === -1) {
									...
									i.extend(true, a.aoPreSearchCols,
											c.aoSearchCols);
									b.saved_aoColumns = [];
					...
					function lb(a, b, c, d, e) {
						...
						a = a + "_"
								+ c.pop().replace(/[\/:]/g, "").toLowerCase();
						var g;
						if (e !== null) {
							g = typeof i.parseJSON === "function" ? i
									.parseJSON(b) : eval("(" + b + ")");
							b = e(a, g, f.toGMTString(), c.join("/") + "/")
						} else
							b = a + "=" + encodeURIComponent(b) + "; expires="
									+ f.toGMTString() + "; path=" + c.join("/")
									+ "/";
						a = s.cookie.split(";");
						e = b.split(";")[0].length;
						f = [];
					...
					function O(a, b, c) {
						a = a === null ? "DataTables warning: " + c
								: "DataTables warning (table id = '"
										+ a.sTableId + "'): " + c;
						if (b === 0)
							if (l.ext.sErrMode == "alert")/* alert(a) */
								;
							else
								throw new Error(a);
						else
					...
					function ib(a) {
						...
						a.oBrowser.bScrollOversize = i("#DT_BrowserTest", b)[0].offsetWidth === 100 ? true
								: false;
					...
					var ga = /\[.*?\]$/, kb = la.JSON ? JSON.stringify
							: function(a) {
								var b = typeof a;
								if (b !== "object" || a === null) {
									if (b === "string")
					...
					this.fnDestroy = function(a) {
						...
						if (!a) {
							e = 0;
							for (f = b.aoColumns.length; e < f; e++)
								b.aoColumns[e].bVisible === false
										&& this.fnSetColumnVis(e, true)
						}
						i(b.nTableWrapper).find("*").andSelf().unbind(".DT");
						i("tbody>tr>td." + b.oClasses.sRowEmpty, b.nTable)
								.parent().remove();
						...
						i("th, td", b.nTHead).removeClass(
								[ b.oClasses.sSortable,
										b.oClasses.sSortableAsc,
										b.oClasses.sSortableDesc,
										b.oClasses.sSortableNone ].join(" "));
						if (b.bJUI) {
							i(
									"th span." + b.oClasses.sSortIcon
											+ ", td span."
											+ b.oClasses.sSortIcon, b.nTHead)
									.remove();
							i("th, td", b.nTHead).each(
									function() {
										var g = i("div."
												+ b.oClasses.sSortJUIWrapper,
												this), j = g.contents();
										i(this).append(j);
										g.remove()
									})
					...
					this.fnGetData = function(a, b) {
						...
						if (a !== p) {
							...
							if (b !== p)
								return F(c, d, b, "");
							return c.aoData[d] !== p ? c.aoData[d]._aData
									: null
						}
						return oa(c)
					};
					...
					this.fnGetPosition = function(a) {
						var b = C(this[l.ext.iApiIndex]), c = a.nodeName
								.toUpperCase();
						if (c == "TR")
							return V(b, a);
						else if (c == "TD" || c == "TH") {
						...
						if (g[a].bVisible != b) {
							if (b) {
								...
								for (f = j.length; e < f; e++)
									if (j[e].nTr !== null)
										m ? j[e].nTr
												.appendChild(j[e]._anHidden[a])
												: j[e].nTr.insertBefore(
														j[e]._anHidden[a], W(d,
																e)[k])
							} else {
								e = 0;
					...
					this.fnUpdate = function(a, b, c, d, e) {
						...
						f.asDataSearch[c] = Da(f, na(f, b, "filter", A(f,
								"bSearchable")));
						if (e === p || e)
							o(f);
						if (d === p || d)
					...
					this
							.each(function() {
								...
								if (this.nodeName.toLowerCase() != "table")
									...
									if (c === null || c === "")
										this.id = c = "DataTables_Table_"
												+ l.ext._oExternConfig.iNextUnique++;
									var g = i
											.extend(true, {},
													l.models.oSettings, {
														nTable : this,
														oApi : sa.oApi,
														oInit : h,
														sDestroyWidth : i(this)
																.width(),
														sInstance : c,
														sTableId : c
													});
									l.settings.push(g);
									g.oInstance = sa.length === 1 ? sa
											: i(this).dataTable();
									h || (h = {});
									...
									r(g.oScroll, h, "bScrollCollapse",
											"bCollapse");
									r(g.oScroll, h, "bScrollInfinite",
											"bInfinite");
									r(g.oScroll, h, "iScrollLoadGap",
											"iLoadGap");
									r(g.oScroll, h, "bScrollAutoCss",
											"bAutoCss");
									r(g, h, "asStripeClasses");
									...
									r(g, h, "bJQueryUI", "bJUI");
									r(g, h, "fnCookieCallback");
									r(g, h, "fnStateLoad");
									r(g, h, "fnStateSave");
									r(g.oLanguage, h, "fnInfoCallback");
									J(g, "aoDrawCallback", h.fnDrawCallback,
											"user");
									J(g, "aoServerParams", h.fnServerParams,
											"user");
									J(g, "aoStateSaveParams",
											h.fnStateSaveParams, "user");
									J(g, "aoStateLoadParams",
											h.fnStateLoadParams, "user");
									J(g, "aoStateLoaded", h.fnStateLoaded,
											"user");
									J(g, "aoRowCallback", h.fnRowCallback,
											"user");
									J(g, "aoRowCreatedCallback",
											h.fnCreatedRow, "user");
									J(g, "aoHeaderCallback",
											h.fnHeaderCallback, "user");
									J(g, "aoFooterCallback",
											h.fnFooterCallback, "user");
									J(g, "aoInitComplete", h.fnInitComplete,
											"user");
									J(g, "aoPreDrawCallback",
											h.fnPreDrawCallback, "user");
									if (g.oFeatures.bServerSide
											&& g.oFeatures.bSort
											&& g.oFeatures.bSortClasses)
										J(g, "aoDrawCallback", ba,
									...
									if (h.bJQueryUI) {
										...
										if (h.sDom === l.defaults.sDom
												&& l.defaults.sDom === "lfrtip")
											g.sDom = '<"H"lfr>t<"F"ip>'
									} else
									...
									if (h.iDeferLoading !== null) {
										...
										g._iRecordsDisplay = a ? h.iDeferLoading[0]
												: h.iDeferLoading;
										g._iRecordsTotal = a ? h.iDeferLoading[1]
												: h.iDeferLoading
									}
									if (h.aaData !== null)
										f = true;
									if (h.oLanguage.sUrl !== "") {
										...
										i.getJSON(g.oLanguage.sUrl, null,
												function(k) {
													Fa(k);
													i.extend(true, g.oLanguage,
															h.oLanguage, k);
													ra(g)
												});
										e = true
									...
									if (b) {
										c = false;
										d = i(this).children("tbody").children(
												"tr:lt(" + b + ")");
										for (a = 0; a < b; a++)
											if (d
													.hasClass(g.asStripeClasses[a])) {
												c = true;
												g.asDestroyStripes
														.push(g.asStripeClasses[a])
											}
										c
												&& d
														.removeClass(g.asStripeClasses
																.join(" "))
									}
									c = [];
									...
									a = 0;
									for (b = d.length; a < b; a++) {
										if (h.saved_aoColumns !== p
												&& h.saved_aoColumns.length == b) {
											if (d[a] === null)
												d[a] = {};
									...
									ba(g);
									ib(g);
									a = i(this).children("caption").each(
											function() {
												this._captionSide = i(this)
														.css("caption-side")
											});
									...
									g.nTBody.setAttribute("aria-relevant",
											"all");
				...
				l.fnIsDataTable = function(h) {
					for ( var n = l.settings, q = 0; q < n.length; q++)
						if (n[q].nTable === h || n[q].nScrollHead === h
								|| n[q].nScrollFoot === h)
							return true;
					return false
				};
				l.fnTables = function(h) {
					var n = [];
					jQuery.each(l.settings, function(q, o) {
				...
				l.defaults = {
					...
					fnStateLoad : function(h) {
						h = this.oApi._fnReadCookie(h.sCookiePrefix
								+ h.sInstance);
						var n;
						try {
							n = typeof i.parseJSON === "function" ? i
									.parseJSON(h) : eval("(" + h + ")")
						} catch (q) {
							n = null
						}
					...
					fnStateSave : function(h, n) {
						this.oApi._fnCreateCookie(
								h.sCookiePrefix + h.sInstance, this.oApi
										._fnJsonString(n), h.iCookieDuration,
								h.sCookiePrefix, h.fnCookieCallback)
					},
				...
				l.models.oSettings = {
					...
					fnRecordsTotal : function() {
						return this.oFeatures.bServerSide ? parseInt(
								this._iRecordsTotal, 10)
								: this.aiDisplayMaster.length
					},
					fnRecordsDisplay : function() {
						return this.oFeatures.bServerSide ? parseInt(
								this._iRecordsDisplay, 10)
								: this.aiDisplay.length
					},
					fnDisplayEnd : function() {
						return this.oFeatures.bServerSide ? this.oFeatures.bPaginate === false
								|| this._iDisplayLength == -1 ? this._iDisplayStart
								+ this.aiDisplay.length
								: Math.min(this._iDisplayStart
								...
								l.ext.oPagination,
								{
									two_button : {
										fnInit : function(h, n, q) {
											var o = h.oLanguage.oPaginate, v = function(
													D) {
												h.oApi._fnPageChange(h,
														D.data.action)
														&& q(h)
											};
											o = !h.bJUI ? '<a class="'
													+ h.oClasses.sPagePrevDisabled
													+ '" tabindex="'
													+ h.iTabIndex
													+ '" role="button">'
													+ o.sPrevious
													+ '</a><a class="'
													+ h.oClasses.sPageNextDisabled
													+ '" tabindex="'
													+ h.iTabIndex
													+ '" role="button">'
													+ o.sNext + "</a>"
													: '<a class="'
															...
															+ h.oClasses.sPageJUIPrev
															+ '"></span></a><a class="'
															+ h.oClasses.sPageNextDisabled
															+ '" tabindex="'
															+ h.iTabIndex
															+ '" role="button"><span class="'
															+ h.oClasses.sPageJUINext
															+ '"></span></a>';
											i(n).append(o);
											var w = i("a", n);
											o = w[0];
											...
											if (!h.aanFeatures.p) {
												...
												o.setAttribute("aria-controls",
														h.sTableId);
												w.setAttribute("aria-controls",
														h.sTableId)
											}
										},
										fnUpdate : function(h) {
											if (h.aanFeatures.p)
												for ( var n = h.oClasses, q = h.aanFeatures.p, o, v = 0, w = q.length; v < w; v++)
													if (o = q[v].firstChild) {
														o.className = h._iDisplayStart === 0 ? n.sPagePrevDisabled
																: n.sPagePrevEnabled;
														o = o.nextSibling;
														o.className = h
																.fnDisplayEnd() == h
																.fnRecordsDisplay() ? n.sPageNextDisabled
																: n.sPageNextEnabled
													}
										}
									},
									...
									full_numbers : {
										fnInit : function(h, n, q) {
											var o = h.oLanguage.oPaginate, v = h.oClasses, w = function(
													G) {
												h.oApi._fnPageChange(h,
														G.data.action)
														&& q(h)
											...
											h.oApi._fnBindAction(v, {
												action : "previous"
											}, w);
											h.oApi._fnBindAction(A, {
												action : "next"
											}, w);
										...
										fnUpdate : function(h, n) {
											if (h.aanFeatures.p) {
												var q = l.ext.oPagination.iFullNumbersShowPages, o = Math
														.floor(q / 2), v = Math
														.ceil(h
																.fnRecordsDisplay()
																/ h._iDisplayLength), w = Math
														.ceil(h._iDisplayStart
																/ h._iDisplayLength) + 1, D = "", A, G = h.oClasses, E, Y = h.aanFeatures.p, ma = function(
														R) {
													h.oApi
															._fnBindAction(
																	this,
												...
												for (o = Y.length; q < o; q++) {
													...
													if (E.hasChildNodes()) {
														...
														i([ E[0], E[1] ])
																.addClass(
																		w == 1 ? G.sPageButtonStaticDisabled
																				: G.sPageButton);
														i([ E[2], E[3] ])
																.addClass(
																		v === 0
																				|| w === v
																				|| h._iDisplayLength === -1 ? G.sPageButtonStaticDisabled
																				: G.sPageButton)
													}
												}
											}
