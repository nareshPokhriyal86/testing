    ...
    function Qb() {
        ...
        function e(i) {
            ...
            for (P = 0; P < E; P++) {
                ...
                //alert("Qa(n.title)"+Qa(n.title))
                var titleDate = n.title.split("~");
                var ttle = titleDate[0];
                var dt = titleDate[1];
                //alert("dt = "+dt);
                k += Y ? "<a href='" + Qa(Y) + "'" : "<div";
                ...
                k += "<span class='fc-event-title' rel='popover' style='width:100%'  onclick=getCalendarDate(this);>" + Qa(ttle) + "<span id='"+dt+"' style='display:none'>~"+dt+"</span></span></div>";
                //counter_Date++;
