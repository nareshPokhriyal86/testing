...
<script src="../js/common-graphs.js"></script>
							...
							<div>
								...
								<div class="jarviswidget-editbox">
									...
									<div>
										...
										<span data-widget-setstyle="green" class="green-btn"></span> <span
											data-widget-setstyle="yellow" class="yellow-btn"></span> <span
											data-widget-setstyle="orange" class="orange-btn"></span> <span
											data-widget-setstyle="pink" class="pink-btn"></span> <span
								...
								<div class="inner-spacer widget-content-padding">
									...
									<ul class="nav nav-tabs" id="myTab1" style="font-size:16px;">
										<li class="active">
											<a href="#s1" onclick="showDonut();onAdvertiserTabClick(this); getText(this);"	id="per_sum" data-toggle="tab">Performance Summary</a></li>
										<li >
											<a href="#s2" onclick="hideDonut(); getText(this);onAdvertiserTabClick(this);" id="tre_ana"
											data-toggle="tab">Trends and Analysis</a></li>
										<li  >
											<a href="#s3" onclick="hideDonut(); getText(this);onAdvertiserTabClick(this);" id="rea_pre"
											data-toggle="tab">Reallocation</a></li>
										<li>

											<a href="#s4" onclick="hideDonut(); getText(this);onAdvertiserTabClick(this);" id="indus_new"
											data-toggle="tab">Industry News and Research</a></li>
...
<!-- <div id="ajax_id" class="ajax_loader" style="display: none;">
...
<div id="myModalRichMedia" class="modal1 hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalRichMediaLabel" aria-hidden="true" style="top:8%;left:19% !important;right:8%;margin-left:0px;display:none;width:830px !important;">
	<div class="modal-header" style="width: 800px !important;">
		<button type="button" class="close1" data-dismiss="modal" aria-hidden="true">×</button>
		<h3 id="myModalLabel1">Tarbox | 2013 Weather Sponsorship | Weather - newsTouch | Apple iOS - App - iPad</h3>
	</div>
	<div class="modal-body" id ="modalDivId1" style="width: 800px !important;">
		
		<div class="pop_image" style="background:white;width:812px;margin-left:-6px;margin-top:-6px;">
			<img src="/img/golfsmith_coupon.png" width="320" height="250">
		</div>
		<div  style="background:white;height: 346px;width:812px;margin-left:-6px;">
		<div class="analytics-boards">
                           <div class="board-container" style="width:46%;margin-right:6%;">
                            <div class="board has-chart" style="padding:0px;">
                               <div style="margin-top:-10px;padding:0px;text-align:center;background-color:grey;height:58px">
                                 <h2 class="account-color"  style="color:white;">Coupons Downloaded</h2>
                                  <div class="icon impressions"></div> 
                                  <div class="big-number" style="margin-left: 10px;margin-top:16px;">122</div>
                                  </div>
                                   <!-- <div class="subtitle">All ads</div> -->
                                     <!-- <div class="change_diffrence">5.25%</div>
                                     <div class="change_arrow"><img src="/img/up_arrow_green.jpeg" width="32"></div> -->
                                 <div class="chart-area"> 
                                    
                                     <div id="chart_div_coupon" style="width: 360px; height: 150px;"></div>
                                       
                                </div> 
                                <div class="filter_data"  style="margin-top:10px;border-bottom:none;">
                                    <div class="filter_data_left">
                                        <h3 class="filter_left_tittle">Coupons</h3>
                                        <div class="filter_left_content">15% Coupon </div>
                                        <div class="filter_left_content">Custom Fit</div>
                                        <!-- <div class="filter_left_content">Tribune</div> -->
                                    </div>
                                    <div class="filter_data_right">
                                        <h3 class="filter_right_tittle">Count</h3>
                                        <div class="filter_right_content">82</div>
                                        <div class="filter_right_content">40</div>
                                       <!--  <div class="filter_right_content">157845</div> -->
                                    </div> 
                                </div>
                       ...
                       <div class="analytics-boards">
                           <div class="board-container" style="width:46%;">
                            <div class="board has-chart" style="padding:0px;">
                                 <div style="margin-top:-10px;padding:0px;text-align:center;background-color:grey;height:58px">
                                 <h2 class="account-color" style="color:white;">Find Store</h2>
                                ...
                                <div class="chart-area"> 
                                     ...
                                     <div id="chart_div_rich" style="width: 360px; height: 150px;"></div>
                                     
                                       
                                </div> 
                                <div class="filter_data" style="margin-top:10px;border-bottom:none;">
                                    <div class="filter_data_left">
                                        <h3 class="filter_left_tittle">Sites</h3>
                                        <div class="filter_left_content">Site 1</div>
                                        <div class="filter_left_content">Site 2</div>
                                        <div class="filter_left_content">Site 3</div>
                                    </div>
                                    <div class="filter_data_right">
                                        <h3 class="filter_right_tittle">Count</h3>
                                        <div class="filter_right_content">43</div>
                                        <div class="filter_right_content">40</div>
                                        <div class="filter_right_content">29</div>
                                    </div>
                                </div>
...
<!-- modal popover stucture -->	
										...
										<div class="agency" >
												...
												<div class="frl" style="float:left;width:48%;">
														...
														<div class='widget alert alert-info-header adjusted agency_option' style='clear:none;float:left;margin-left:10px;box-shadow:none;border:none;margin-top: 4px;'> 
														   <div style='float:left;margin-left:-21px;color:white;'> 
														      <strong style='text-transform: uppercase;'>All</strong> 
														      </div>
														 </div>
												</div>
												
												<div class="channel_div" style="float:left;width:50%;clear:none;">
														<div id="advertiser_first" class="f_channel">ADVERTISER : </div>
														<div class='widget alert alert-info-header adjusted advertiser_option' style='clear:none;float:left;margin-left:10px;box-shadow:none;border:none;margin-top: 4px;'>    <div style='float:left;margin-left:-21px;color:white;'>  
														  <strong style='text-transform: uppercase;'>All</strong> 
														  </div>
														  </div>
												</div>
												...
												<div id="advertiser_performance_summary_header" class="mystats indented revenue_bg" style="height:45px;">
													<div style="width:98%;float:left;">
												<!-- 	<div class="summary_bar" >
														<div style="font-size:1em;">TOTAL BUDGET</div>
														<div class="summary_value"></div>
													</div>
													<div class="summary_bar">
														<div style="font-size:1em;">TOTAL REVENUE DELIVERED</div>
														<div class="summary_value"></div>
													</div>
													<div class="summary_bar">
														<div style="font-size:1em;">TOTAL REVENUE REMAINING</div>
														<div class="summary_value"></div>
													</div>
													<div class="summary_bar">
														<div style="font-size:1em;">BOOKED IMPRESSIONS</div>
														<div class="summary_value"></div>
													</div>
													<div class="summary_bar" >
														<div style="font-size:1em;">LIFETIME IMPRESSIONS</div>
														<div class="summary_value"></div>
													</div>
													<div class="summary_bar">
														<div style="font-size:1em;">LIFETIME CLICKS</div>
														<div class="summary_value"></div>
													</div>
													<div class="summary_bar">
														<div style="font-size:1em;">LIFETIME CTR</div>
														<div class="summary_value"></div>
													</div>
													</div>
											...
											<div class="fluid-container" >
												...
												<!-- widget grid -->
												<section id="widget-grid" class=""> <!-- row-fluid -->
												<div class="row-fluid" style="margin-top:10px;">

													<!-- article -->
													<article class="span12" style="margin-top:20px;"> <!-- new widget -->
													<div
														...
														<div>
															...
															<div id = "topPerformLineItemDiv" class="inner-spacer">
																<div class="widget alert alert-warning adjusted">
																	...
																	Top campaign line items with the highest absolute CTR%
																	values.
																</div>
																<!-- content goes here -->
																<table id="topPerformLineItemTable" class="table text-left">
																	<thead>
																		<tr>
																			...
																			<th style="text-align:right;">IMPRESSION DELIVERED</th>
														...
														<div>
															...
															<div class="inner-spacer">
																<div class="widget alert alert-warning adjusted">
																	<button class="close" data-dismiss="alert">×</button>
																	<i class="cus-exclamation-octagon-fram"></i> <strong>NOTE:</strong>
																	Top under-delivering campaign line items with highest
																	delivery variance.
																</div>
																<!-- content goes here -->
												...
												<div class="row-fluid">
													...
													<!-- article -->
													<article class="span6"> <!-- new widget -->
													<div
													...
													<div class="jarviswidget">
														...
														<div>
															...
															<div class="inner-spacer">
																...
																<div id="advertiserGeoMapByLocation" rel="popover" class="chart geo_map_market"></div>
												...
												<div class="row-fluid">
														...
														<div>
															...
															<div class="inner-spacer">
																<div class="widget alert alert-warning adjusted">
																	<button class="close" data-dismiss="alert">×</button>
																	<i class="cus-exclamation-octagon-fram"></i> <strong>NOTE:</strong>
																	Top campaign line items with the highest CTR gain from
																	previous period.
																</div>
																<!-- content goes here -->
																<table class="table text-left table-hover"
													...
													<div class="jarviswidget">
														<header>
														<h2>BY MARKET</h2>
														<div id="by_market_zoom" style="margin-left: 110px;margin-top: 7px;"><i class="icon-zoom-in"></i></div>
														</header>
														...
														<div>
															...
															<div class="inner-spacer">
																...
																<!-- geo chart -->
																<div id="advertiserGeoMapByMarket" rel="popover" class="chart geo_map_market"></div>
																<!-- end content -->
															</div>
														...
														<div>
															...
															<div class="inner-spacer">
																<div class="widget alert alert-warning adjusted">
																	<button class="close" data-dismiss="alert">×</button>
																	<i class="cus-exclamation-octagon-fram"></i> <strong>NOTE:</strong>
																	Top campaign line items with the highest CTR loss from
																	previous period.
																</div>
																<!-- content goes here -->
																<table id="topLosersLineItemsTable" class="table text-left">
																	<thead>
																		<tr>
																			<th>CAMPAIGN LINE ITEMS</th>
																			<th>CTR(%)</th>
												...
												<div class="row-fluid">
													...
													<div class="jarviswidget">
														...
														<div>
															...
															<div class="inner-spacer">
																<!-- content goes here -->
																<table class="table dtable" id="performanceMetricsTable">
																	<thead>
																		<tr>
																			<!-- <th>Date</th> -->
																			<th>CAMPAIGN IO</th>
										...
										<div class="tab-pane" id="s2">
											...
											<div class="agency">
												...
												<div class="frl" style="float:left;width:48%;">
													...
													<div class='widget alert alert-info-header adjusted order_option' style='clear:none;float:left;margin-left:10px;box-shadow:none;border:none;margin-top: 7px;'> 
													   <div style='float:left;margin-left:-21px;color:white;'>  
												...
												<div class="channel_div" style="float:left;width:50%;clear:none;">
													<div id="lineItem_trends"class="f_channel">LINE ITEMS :</div>
													<div class='widget alert alert-info-header adjusted lineOrder_option' style='clear:none;float:left;margin-left:10px;box-shadow:none;border:none;margin-top: 7px;'> 
													   	<div style='float:left;margin-left:-21px;color:white;'>  
													     	<strong style='text-transform: uppercase;'></strong> 
													    </div>
												    </div>	
											...
											<div id = "advertiser_trends_analysis_header" class="mystats indented revenue_bg" style="height:45px;">
													<div style="width:98%;float:left;">
													<!-- <div class="summary_bar" >
														<div style="font-size:1em;">TOTAL BUDGET</div>
														<div class="summary_value"></div>
											...
											<div id="trends_left"  class="actual">
												...
												<div class="chart_box">
													<div id="chart_div_left3_icon"><i class="icon-zoom-in"></i></div>
													<div id="chart_div_left3" rel="popover"></div>
												</div>
												<div class="chart_box">
													<div id="chart_div_left1_icon"><i class="icon-zoom-in"></i></div>
													<div id="chart_div_left1" rel="popover"></div>
												</div>
												<div class="chart_box">
													<div id="chart_div_left2_icon"><i class="icon-zoom-in"></i></div>
											...
											<div id="trends_right" class="actual">
												...
												<div class="chart_box">
													<div id="chart_div_right3_icon"><i class="icon-zoom-in"></i></div>
													<div id="chart_div_right3" rel="popover"></div>
												</div>
												<div class="chart_box">
													<div id="chart_div_right1_icon"><i class="icon-zoom-in"></i></div>
													<div id="chart_div_right1" rel="popover"></div>
												</div>
												<div class="chart_box">
												<div id="chart_div_right2_icon"><i class="icon-zoom-in"></i></div>
											...
											<div class="fluid-container">
													...
													<div class="jarviswidget">
														...
														<div>
															...
															<div class="inner-spacer">
																<!-- content goes here -->
																<table
																	id="actualAdvertiserTable" class="table dtable" >
																	<thead>
																		<tr>
																			<th>DATE</th>
																			<th>ORDER</th>
												...
												<!-- end row-fluid --> </br>
												<!--end--> <!-- div for right table --> <!-- row-fluid -->
												<div class="row-fluid">
													<article class="span12"> <!-- new widget -->
													<div class="jarviswidget">
														<header>
														...
														<div>
															...
															<div class="inner-spacer">
																<!-- content goes here -->
																<table
																	id="forcastAdvertiserTable" class="table dtable"
																	>
																	<thead>
																		<tr>
																			<th>DATE</th>
										...
										<div class="tab-pane" id="s3">
											...
											<%-- <div class="mystats indented summary_header1 campagen_order_top_bg">
													
													<div class="order_dd summary_bar">
														<div class="dd_div_heading">CAMPAIGN ORDER</div>
														<div id="order_dropdown" class="btn-group order_group" >
															<a class="btn btn-inverse btn-small" href="javascript:void(0);" class="dd_selected">
															  <span id="order_val">All</span>
															</a> 
															<a class="btn btn-inverse btn-small dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);">
													...
													<div class="lineItem_dd summary_bar">
														<div  style="">LINE ORDER</div>
														
														<div id="lineItemName_dropdown" class="btn-group order_group">
												<a class="btn btn-inverse btn-small" href="javascript:void(0);" class="dd_selected">
													<span id="lineItem_val">All</span>
											    </a> 
												...
												<ul class="dropdown-menu">
													...
													<div class="advertiser_time_main">
													<div class="advertiser_time_heading">TIME PERIOD</div>
													<div id="advertiser_time_data_reallocation_div"
														class="advertiser_time_data">This Week
												    </div>
												</div>
												
												<a class="btn btn-info btn-small" href="javascript:loadAllData()">Go</a>
												</div>
												
							<div id="advertiser_reallocation_header" class="mystats indented summary_header2">	
													<div class="summary_bar">
														<div class="summary_name" >TOTAL BUDGET</div>
														<br>
														<div class="summary_value">$13524</div>
														
													</div>
													<div class="summary_bar">
														<div class="summary_name">START DATE</div>
														<br>
														<div class="summary_value">12/01/2012</div>
														
													</div>
													<div class="summary_bar">
														<div class="summary_name">END DATE</div>
														<br>
														<div class="summary_value">11/30/2013</div>
														
													</div>
													<div class="summary_bar">
														<div class="summary_name">IMPRESSIONS</div>
														<br>
														<div class="summary_value">2,340,000</div>
														
													</div>
													<div class="summary_bar">
														<div class="summary_name">CLICKS</div>
														<br>
														<div class="summary_value">5,670</div>
														
													</div>
													<div class="summary_bar">
														<div class="summary_name">CTR(%)</div>
														<br>
														<div class="summary_value">0.49%</div>
 ...
 --%>
 			<div class="agency" >
												...
												<div class="frl" style="float:left;width:48%;">
													<div id="order_reallocation" class="f_channel">ORDER :</div>
													<div class='widget alert alert-info-header adjusted order_option' style='clear:none;float:left;margin-left:10px;box-shadow:none;border:none;margin-top: 7px;'> 
													   <div style='float:left;margin-left:-21px;color:white;'>  
													     <strong style='text-transform: uppercase;'></strong> 
													     </div>
 ...
 -->
	...
	<div id="popover_content_wrapper" style="display: none;">
		...
		<div class="popup">
			...
			<div id="popheading" class="popup_heading_bg">
				<span class="block_impr"><b>Booked
						Impressions:</b>
				</span><span style="margin-left: 20px;">585,000</span><span
					class="popup_span_cpm"><b>CPM:</b>
				</span><span class="popup_span_cpm_point">$5.78</span>
			</div>
			<div class="popup_line">
				<span class="life_time"><b>Life Time</b>
				</span><span class="flr"><b>This Week</b>
				</span>
			</div>
			...
			<div class="popup_line">
			<span class="popup_span_bcolor">Impressions
					Delivered:</span><span class="popup_span_delivered">283,200</span><span
					class="flr">9,258</span>
			</div>
			<div class="popup_line">
			...
			<div class="popup_line">
					<span class="popup_span_bcolor">Revenue
					Delivered:</span><span class="popup_span_delivered">$1,636.90</span><span
					class="flr">$53.31</span>
			</div>
			<div class="popup_line">
				
				<span class="popup_span_bcolor">Revenue
					Remeining:</span><span class="popup_span_remeining">$1,744.40</span><span
					class="flr">$1,690.88</span>
			</div>
			<div id="chart_div" class="popup_chart"></div>
			<div class="popup_chart_bg">
				<a class="btn btn-inverse medium view_trends" href="#" data-toggle="tab"
					
					onclick="viewperformance()">View Trends</a> <a
					class="btn btn-inverse medium location11" href="#" data-toggle="tab"
					
					onclick="reallcation()">Reallocation</a>
    ...
    <jsp:include page="js.jsp"/>
    	...
    	<!-- Google Geo Chart -->
	<script src="../js/include/adv_charts/geochart.js"></script>
	...
	$(document).ready(function(){
		$('#tre_ana').click(function(){
			$('#s4').hide();
			var oTableTools = TableTools.fnGetInstance('actualAdvertiserTable');
			if ( oTableTools != null && oTableTools.fnResizeRequired()) {
				oTableTools.fnResizeButtons();
			}
			oTableTools = TableTools.fnGetInstance('forcastAdvertiserTable');
			if ( oTableTools != null && oTableTools.fnResizeRequired()) {
				oTableTools.fnResizeButtons();
			}
		});
	...
	function showDonut() {
		try{
		$('#'+advertiserDonutGraph).css({"display":"block"});
		}catch(error){}
	}
	
	function hideDonut() {
		try{
		   $('#'+advertiserDonutGraph).css({"display":"none"});
		}catch(error){
...
/* end reallocation script */
	    ...
	    labelColor: '#F0F8FF',
			  data: [
			  {value: 93.75, label: 'Remaining'},
			    {value: 6.25, label: 'Complete'},		    
			  ],
