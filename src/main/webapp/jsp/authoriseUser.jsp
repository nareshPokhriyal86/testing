...
<title>ONE - Authorise User</title>
		...
		<!-- tool bar -->
			<div id="header-toolbar" class="container-fluid">
				...
				<div class="contained">
					...
					<!-- theme name -->
					<h1>
					 <!-- <img src="../img/synergyMAP-logo-wht.png" width="100"/>  -->
					<img src="../img/SynergyMapImages.png" width="" height="32"/>
					<!-- <div class="site_title">ONE Analytics</div> -->
								...
								<article class="span12 sortable-grid ui-sortable">
									...
									<div class="jarviswidget jarviswidget-sortable" id="widget-id-0" role="widget">
									    ...
									    <div role="content">
									        ...
									        <!-- content goes here -->
												<s:form id="validate-demo-js" cssClass="form-horizontal themed" action="authorizeUser" onsubmit="confirmEmail('password', 'passwordRepeat');">
														<fieldset>
																<div class="row-fluid">
																										

																	<div class="control-group">
																		<label class="control-label">Enter Password<span class="req star" 
																				>*</span></label>
																		<div class="controls">
																	...
																	<div class="control-group" style="background:none">
																		<label class="control-label">Confirm Password<span class="req star" 
																				>*</span></label>
																		<div class="controls">
																	...
																	<div class="form-actions" style="min-height:0px;">
																		...
																		<button type="submit" class="btn medium btn-success">
																			Submit
																		</button>
																	</div>
