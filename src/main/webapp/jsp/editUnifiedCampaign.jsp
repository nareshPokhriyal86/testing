   			 ...
   			 <h1 id="page-header" style="margin-left: 1%;">Unified Campaign</h1>
   				 ...
   				 <div class="fluid-container" id ="removeBorderForm" style="background-color: white;" >
   					 <section id="widget-grid" class="">
   					  <s:form name = "unifiedCampaignForm" id="select-demo-js" cssClass="form-horizontal themed" onsubmit="return getJsonData();" action="saveCampaign.lin" >
   					  <div id="step1Id">
   					 	   <div class="row-fluid" >
								  <article class="span6">
   					 ...
   					 <%-- 	   			 <div class="row-fluid" >
							 ...
							 <article class="span6">
									...
									<button type="button" id="nextButtonid" onclick="backTab()" class="btn btn-primary btn-large">Back</button>
										...
										<button type="button" onclick="cancleTab()" class="btn btn-danger btn-large">Cancel</button>
										 <button type="button" id="nextButtonid" onclick="placementTab()" style="float: right;" class="btn btn-primary btn-large">Add Placement</button> 
									</div>
								</article>
							</div>
   					 	    	...
   					 	    	<div class="control-group" style="border-bottom: none;">
											...
											<div class="control-group" style="border-bottom: none;">
										    	...
										    	<div class="controls">
																<div class="input-append date" id="datepicker-js"  data-date-format="mm-dd-yyyy">
																	...
																	name="unifiedCampaignDTO.pStartDate" value="<s:property value="unifiedCampaignDTO.startDate"/>"/>
																	<span class="add-on"><i class="cus-calendar-2"></i></span>
																</div>
																to
																<div class="input-append date" id="datepicker-js"  data-date-format="mm-dd-yyyy">
																	<input class="datepicker-input" size="16" type="text"  id="pEndtDate" placeholder="Select a date" 
																	name="unifiedCampaignDTO.pEndDate" value="<s:property value="unifiedCampaignDTO.endDate"/>"/>
																	<span class="add-on"><i class="cus-calendar-2"></i></span>
																</div>
   					 	         ...
   					 	         <div class="row-fluid" >
											...
											<div class="control-group" style="border-bottom: none;">
												...
												<div class="controls">
													<s:select Class="span12 with-search"	multiple="true" id="selectAppViews"
				           						 		name="unifiedCampaignDTO.pSelectedPlatform" list="unifiedCampaignDTO.plateformList" listKey="id" listValue="value" value="%{unifiedCampaignDTO.selectedPlatformList.{id}}">
				           							</s:select>
												</div>
											</div>
											</article>
											...
											<div class="control-group" style="border-bottom: none;">
												...
												<div class="controls">
													<s:select Class="span12 with-search"	multiple="true" id="selectAppViews"
				           						 		name="unifiedCampaignDTO.pSelectedCreative" list="unifiedCampaignDTO.creativeList" listKey="id" listValue="value" value="%{unifiedCampaignDTO.selectedCreativeList.{id}}">
				           							</s:select>
												</div>
											</div>
											</article>
											...
											<div class="control-group" style="border-bottom: none;">
												...
												<div class="controls">
													<s:select Class="span12 with-search"	multiple="true" id="selectAppViews"
				           						 		name="unifiedCampaignDTO.pSelectedContext" list="unifiedCampaignDTO.contextList" listKey="id" listValue="value" value="%{unifiedCampaignDTO.selectedContextList.{id}}">
				           							</s:select>
												</div>
											</div>
											</article>
											...
											<div class="control-group" style="border-bottom: none;">
												...
												<div class="controls">
													<s:select Class="span12 with-search"	multiple="true" id="selectAppViews"
				           						 		name="unifiedCampaignDTO.pSelectedDevice" list="unifiedCampaignDTO.deviceList" listKey="id" listValue="value" value="%{unifiedCampaignDTO.selectedDeviceList.{id}}">
				           							</s:select>
												</div>
											</div>
											</article>
											...
											<label class="control-label">Goal<span class="req star">*</span>
												...
												<div class="controls">
													<input class="span12" required="required"  maxlength="49" type="text" placeholder="Total Goal" 
													                    id="totalGoalPlacement" name="unifiedCampaignDTO.pTotalGoal" value="<s:property value="unifiedCampaignDTO.totalGoal"/>">
												</div>
											</div>
											</article>
                             						<article class="span6">
											<div class="control-group" style="border-bottom: none;">
													...
													<div class="controls">
														<input class="span12" required="required" title="Name is required" placeholder="Budget"
														type="number" id="budget" name="unifiedCampaignDTO.pBudget" value="<s:property value="unifiedCampaignDTO.budget"/>">
													</div>
												</div>
												</article>
											...
											<div class="row-fluid" >
												<article class="span6">
														<div class="control-group" style="border-bottom: none;">
																...
																<div class="controls">
																	<s:select cssClass="span12 with-search"	multiple="true" id="selectedCountryList"
				           										 		name="unifiedCampaignDTO.pSelectedCountry" list="unifiedCampaignDTO.countryList" listKey="id" listValue="value" value="%{unifiedCampaignDTO.selectedCountryList.{id}}">
				           										</s:select>
														</div>
													</div>
												  </article>
													...
													<article class="span6">
														<div class="control-group" style="border-bottom: none;">
																...
																<div class="controls">
																	<s:select cssClass="span12 with-search"	multiple="true" id="selectedDMAList"
				           										 		name="unifiedCampaignDTO.pSelectedDMA" list="unifiedCampaignDTO.dmaList" listKey="id" listValue="value" value="%{unifiedCampaignDTO.selectedDMAList.{id}}">
				           										</s:select>
														</div>
													</div>
												  </article>
										...
										<div class="row-fluid" >
											...
											<div class="control-group" style="border-bottom: none;">
										    		<label class="control-label" for="multiSelect">State</label>
														<div class="controls">
															<s:select cssClass="span12 with-search"	multiple="true" id="selectAppViews"
				           								 		name="unifiedCampaignDTO.pSelectedState" list="unifiedCampaignDTO.stateList" listKey="id" listValue="value" value="%{unifiedCampaignDTO.selectedStateList.{id}}">
				           									</s:select>
													</div>
												</div>
											</article>	
							 ...
							 <article class="span6">
							   ...
							   <div id="loaderId" class=" lineGraphloaderArea jarviswidget" style="height:170px;text-align:center;">
									...
									<button type="button" id="" onclick="backPlacementTab()" class="btn btn-primary btn-large">Back</button>
										...
										<button type="button" onclick="cancleTab()" class="btn btn-danger btn-large">Cancel</button>
										<button type="button" id="nextButtonid" onclick="addMorePlacementTab('<s:property value="unifiedCampaignDTO.id"/>')" class="btn btn-primary btn-large" style="float: right;">Add More</button>
									...
									<input type="hidden" id="campaignPlacementId" name="unifiedCampaignDTO.id" value="" >
									<input type="hidden" id="placmentStatusId" name="unifiedCampaignDTO.statusId" value="" >
									<!-- <input type="hidden" id="placment" name="unifiedCampaignDTO.pCount" value="" > -->
									</s:form>
								</section>
							 </div>
						</div>
