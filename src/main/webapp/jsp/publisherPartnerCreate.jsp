...
<div class="height-wrapper">
	...
	<div id="main" role="main" class="container-fluid">
		...
		<div class="contained">
            ...
            <h1 id="page-header">New Publisher </h1>
		...
		<!-- -----------------   Form starts   --------------------------- -->
		                            <form class="form-horizontal themed">
													<fieldset>
													<div style="font-weight:bold; font-size:13px; color:#000; margin:20px 20px 0px 20px;">Publisher Name:-</div>
													...
													<div class="control-group">
															<label class="control-label" for="multiSelect">Channel / Demand Partners</label>
															<div class="controls">
																<select multiple="multiple" class="span4 with-search">
														...
														<div class="control-group">
															<label class="control-label" for="multiSelect">Properties / Site</label>
															<div class="controls">
																<select multiple="multiple" class="span4 with-search">
													                <option value="KT">KASA-TV</option>
													                <option value="HT">KHON-TV</option>
													                <option value="KI">KIMT-TV</option>
													                <option value="KR">KRQE-TV</option> 
													                <option value="KW">KSNW-TV</option> 
													                <option value="ST">KSNT-TV</option>
													                <option value="NT">KXAN-TV</option>
													                <option value="LT">WALA-TV</option>
													                <option value="NT">WANE-TV</option>
													                <option value="AT">WAVY-TV</option>
													                <option value="DT">WDTN-TV</option>															        </select>
															</div>
														</div>
