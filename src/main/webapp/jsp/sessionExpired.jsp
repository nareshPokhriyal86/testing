...
<html lang="en">
  <head>
    ...
    <title>ONE - Session Expired</title>
	...
	<div class="height-wrapper">
					...
					<div class="pull-right">
						...
						<div id="theme-switcher" class="btn-toolbar">
							...
							<div class="btn-group pull-right visible-phone">
								...
								<a href="login.lin" class="btn btn-inverse btn-small"><i class="icon-off"></i></a>
							</div>
		...
		<!-- end header -->	
			...
			<div class="jarviswidget login" id="login_page" >
				<header>
					<h2><img src="img/oneAnalytics.png" style="width: 120px;margin-right: 6px;margin-top: -14px;">- Sign In</h2>
				</header>
					...
					<div id="main-content" class="login_mainbox">
						...
						<s:form name="loginForm" cssClass="form-signin" id="target" action="login.lin">
							<div class="control-group">
								<input type="email" required="required" title="Email Id is required" name="emailId" class="input-block-level" autofocus placeholder="Email Id" value="">
							</div>
							<div class="control-group">
								<input type="password" name="password" id="passwordId" class="input-block-level" placeholder="Password" value="">
							</div>
							<div class="control-group no-border">
								<div class="signIn_outer">
									<input class="btn btn-login" type="submit" value="Sign in" id="login-btn">
									<div class="signIn_button">
                                    	<a  href="/GoogleLoginOAuthIndexServlet"> Sign in with Google <span>&nbsp;<img src="img/icon_googleaccounts1.png"></span> </a>
                                   	</div>
								</div>
			...
			<div class="jarviswidget login"  style="display:none;" id="forget_password" >
				<header>
					<h2><img src="img/oneAnalytics.png" style="width: 120px;margin-right: 6px;margin-top: -14px;">- Sign In</h2>
				</header>
					...
					<div class="widget alert adjusted-login">
						...
						<strong style="margin-left: -16px;">Please type in your email id</strong>
					</div>
					<!-- content goes here -->
					<div id="main-content" class="login_mainbox">
						
						<s:form class="form-signin" name="forgetPasswordForm" id="target" action="forgetPassword.lin">
							<div class="control-group">
								<input type="email" required="required" title="Email Id is required" name="emailId" class="input-block-level" autofocus placeholder="Email Id" value="">
							</div>
							<div class="control-group no-border">
						  <div class="submit_button">
									<input class="btn btn-login" type="submit" value="Submit" id="login-btn">
